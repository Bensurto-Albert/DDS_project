                    ...
                    <table class="border-collapse: collapse; border: none; "; width="100%"id="dataTable" style="background-color:#FFFFFF; color: #646464;">
                        ...
                        <thead id="thread"  >
                            <tr>
                                ...
                                <th class="text-center"style="font-style:bold;">UPDATE</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="edit" method="post">
                                                ...
                                                <button type="submit" name="btn_edit" class="material-icons"style="color:black;background-color:white;">&#xe3c9;</button>
                                            </form>
                                        </td>
                                        <td class="text-center">
                                            <form action="delete" method="post">
                                                <input type="hidden" name="delete_id" value="<?php echo $id[$x]->id; ?>">
                                                <button type="submit" class="material-icons" style="color:black;background-color:white;">&#xe872;</button>
                                            </form>
